...
Stdlib only, and it imports nothing else from this project. That is deliberate: this is the surface
an external tool needs in order to produce a selection of its own, so it must be installable without
pandas, OpenCV or the rest of the application.
"""
